...
export function Header({ onGeolocate }: HeaderProps) {
  ...
  return (
    <header
      className="absolute top-3.5 left-1/2 -translate-x-1/2 z-30 flex items-center justify-between gap-1.5 sm:gap-2.5 px-3 sm:px-4 py-2 sm:py-2.5 rounded-2xl shadow-2xl backdrop-blur-2xl border border-white/15 pointer-events-auto"
      style={{
        background: "rgba(8, 18, 38, 0.94)",
        width: "calc(100% - 1.5rem)",
        maxWidth: "1080px",
        boxShadow:
          "0 12px 36px rgba(0,0,0,0.55), 0 0 20px rgba(34,197,217,0.12), inset 0 1px 0 rgba(255,255,255,0.08)",
      }}
    >
      {/* Logo */}
      <div className="flex items-center gap-2 flex-shrink-0">
        <div
          className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl flex items-center justify-center text-base sm:text-lg shadow-lg flex-shrink-0"
